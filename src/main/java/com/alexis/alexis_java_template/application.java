...
/**
 * Reworked from the History Buff example provided by Amazon.
 * The original code can be 
 * <a href="https://github.com/amzn/alexa-skills-kit-java/tree/121336de172137039c36963553ede92af8fef137/samples/src/main/java/historybuff">
 * found here </a> 
 * @author g
 */
public class application {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        context.addServlet(new ServletHolder(createServlet(new JavaSpeechlet())), "/hello");
        context.addServlet(new ServletHolder(createServlet(new JavaSpeechlet())), "/session");
        server.start();
        server.join();
    }
